...
This guide explains how to set up a Cloudflare tunnel to expose your ORTHANC-AUTHELIA instance to the Internet securely.
...
Select the domain you want to use (e.g. `yokoinc.ovh`).
...
Check in your Cloudflare dashboard that the CNAME record has been created:
- **Type**: CNAME
- **Name**: pacs
...
### 3. Page rules configuration (optional)
...
Open your browser and go to `https://pacs.yokoinc.ovh`. You should see the Authelia login page.
...
If you use self-signed certificates, remember to renew them regularly:
