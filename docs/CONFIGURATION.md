...
**DO NOT edit this file manually!** Use the administration panel (Users
tab), which is the only path enforcing the invariants. From a console on the
host, when the panel is unreachable:
...
- [ ] **Create the first administrator** through the setup wizard,
      `https://<your-domain>/console/setup`
